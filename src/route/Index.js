        ...
        <Route exact path={`${process.env.PUBLIC_URL}/ecommerce/integration`} component={EcomIntegration}></Route> */}
          ...
          <Route path="analytics" element={<Analytics />}></Route> */}
                ...
                <Route path="ecommerce">
                    ...
                    <Route
                        path="integration"
                        element={<EcomIntegration />}
                    ></Route>
                    <Route element={<CustomerProvider />}>
                        <Route
                            path="customer"
                            element={<EcomCustomer />}
                        ></Route>
                        y
                        <Route
                ...
                <Route
                    path="order-list-default"
                    element={<OrderDefault />}
                ></Route>
                <Route
                    path="order-list-regular"
                    element={<OrderRegular />}
                ></Route>
                ...
                <Route path="app-file-manager">
                    ...
                    <Route
                        path="starred"
                        element={<FileManagerStarred />}
                    ></Route>
                    <Route
                        path="shared"
                        element={<FileManagerShared />}
                    ></Route>
                    <Route
                        path="recovery"
                ...
                <Route path="components">
                    ...
                    <Route path="misc">
                        ...
                        <Route
                            path="dual-list"
                            element={<DualListPage />}
                        ></Route>
                        <Route path="map" element={<GoogleMapPage />}></Route>
                        <Route
                            path="toastify"
                            element={<ReactToastify />}
                        ></Route>
                        <Route
                            path="jsTree"
                            element={<JsTreePreview />}
                        ></Route>
                    </Route>
                </Route>
                <Route path="charts">
