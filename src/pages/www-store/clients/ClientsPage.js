...
useEffect(()=> {
  ...
  return (
    <React.Fragment>
      ...
      <AddClientMoadal open={view.add} formData={formData} setFormData={setFormData} onFormCancel={onFormCancel} setData={setData}/>
<EditClientMoadal open={view.edit} formData={formData} setFormData={setFormData} onFormCancel={onFormCancel}/>
